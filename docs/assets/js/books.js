const books = [
  {
    id: 'Can’t_See_the_Forest_for_the_Trees', category: 'Business & Startups', title: 'Can’t See the Forest for the Trees', subtitle: 'Complexity, Power, and the Duty to See the Whole in the Age of AI', position: 0,
    staticUrl: './books/cant-see-the-forest-for-the-trees/index.html',
    description: 'Each of us tends a tree—job, family, company, cause, or feed—while their combined growth turns the shared forest into a dangerous jungle no one fully sees. An urgent confession about AI slop, pleasant smoothing, finite attention, and our duty as citizens to look up.',
  ...
  {
    id: 'ANTI_IDIOCRACY', category: 'Power, Institutions & Society', title: 'Anti-Idiocracy', subtitle: 'The Outfinitist Metacult Investigation', position: 13,
  ...
  {
    id: 'THE_CIVILIZED_MIND', category: 'Power, Institutions & Society', title: 'The Civilized Mind', subtitle: 'Truth, Power, and the Survival of Plural Democracies in the Age of Extremes', position: 6,
...
function renderListing() {
  ['Business & Startups', 'Executable Science & Research', 'AI Systems & Infrastructure', 'Cosmic & Metaphysical SF', 'Political & Social SF', 'Human & Philosophical SF', 'Outfinitist Foundations', 'Power, Institutions & Society', 'Experiments'].forEach(category => {
